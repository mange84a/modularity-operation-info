...
namespace Operationinfo\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = OPERATIONINFO_PATH . apply_filters(
            'Operationinfo/Helper/CacheBust/RevManifestPath',
            'dist/manifest.json'
        );
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . OPERATIONINFO_PATH . ' and run gulp. See ' . OPERATIONINFO_PATH . 'README.md for more info.</div>';
        }
    }
}
