...
namespace Operationinfo\Entity;
...
class PostType
{
    ...
    public function registerPostType()
    {
        $labels = array(
            ...
            'add_new'             => sprintf(__('Add new %s', 'modularity-operationinfo'), $this->nameSingular),
            'add_new_item'        => sprintf(__('Add new %s', 'modularity-operationinfo'), $this->nameSingular),
            'edit_item'           => sprintf(__('Edit %s', 'modularity-operationinfo'), $this->nameSingular),
            'new_item'            => sprintf(__('New %s', 'modularity-operationinfo'), $this->nameSingular),
            'view_item'           => sprintf(__('View %s', 'modularity-operationinfo'), $this->nameSingular),
            'search_items'        => sprintf(__('Search %s', 'modularity-operationinfo'), $this->namePlural),
            'not_found'           => sprintf(__('No %s found', 'modularity-operationinfo'), $this->namePlural),
            'not_found_in_trash'  => sprintf(__('No %s found in trash', 'modularity-operationinfo'), $this->namePlural),
            'parent_item_colon'   => sprintf(__('Parent %s:', 'modularity-operationinfo'), $this->nameSingular),
