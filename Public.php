...
if (!function_exists('modularity_operationinfo_render_blade_view')) {
    function modularity_operationinfo_render_blade_view($view, $data = [], $compress = true)
    {
        $init = new ComponentLibraryInit([
            OPERATIONINFO_MODULE_VIEW_PATH
        ]);
